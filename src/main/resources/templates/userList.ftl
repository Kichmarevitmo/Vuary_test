            ...
            <tr style="border-bottom: 1px solid #ddd;">
                ...
                <td style="padding: 10px;">
                    <
                        ...
                        <img src="/user/image/$
                        {user.getFirstImage().name}" alt="Изображение котла" style="max-width: 100%; margin-top: 10px;">
                    <
                    /#if>
                </td>
                <td style="padding: 10px;">$
                {user.username! "null"}</td>
                <td style="padding: 10px;">$
                {user.getEmail()! "null"}</td>
                <td style="padding: 10px;"><
                ...
                /#list></td>
                <td style="padding: 10px;">$
                {user.getGender()! "null"}</td>
                <td style="padding: 10px;">$
                {user.getCity()! "null"}</td>
                <td style="padding: 10px;">$
                {user.getLastName()! "null"}</td>
                <td style="padding: 10px;"><
                #list user.workerRoles as workerRoles>$
                {workerRoles}<
                #sep>, <
                /#list></td>
                <td style="padding: 10px;">
                ...
                <td style="padding: 10px;"><a href="/user/$
                {user.id}">Редактировать</a></td>
                <td style="padding: 10px;"><a href="/user/delete/$
                {user.id}" style="color: red;">Удалить</a></td>
            </tr>
        <
        /#list>
        </tbody>
