    ...
    <div style="max-width: 600px; margin: auto;">
        ...
        <form action="/user" method="post" style="margin-top: 20px;">
            ...
            <div style="margin-bottom: 10px;">
                ...
                {user.username}" style="width: 100%;">
            </div>

            <div style="margin-bottom: 10px;">
                <label for="email">Почта:</label>
                <input type="text" id="email" name="email" value="$
                {user.getEmail()?default("")}" style="width: 100%;">
            </div>
            ...
            <div style="margin-bottom: 10px;">
                ...
                <select id="gender" name="gender" style="width: 100%;">
                    <option value="MALE" <
                    #if (user.getGender()!("")) == "MALE">selected<
                    /#if>>Мужской</option>
                    <option value="FEMALE" <
                    #if (user.getGender()!("")) == "FEMALE">selected<
                    /#if>>Женский</option>
                </select>
            </div>
            ...
            <div style="margin-bottom: 10px;">
                ...
                {user.getCity()?default("")}" style="width: 100%;">
            </div>

            <div style="margin-bottom: 10px;">
                <label for="lastName">Фамилия:</label>
                <input type="text" id="lastName" name="lastName" value="$
                {user.getLastName()?default("")}" style="width: 100%;">
            </div>
            ...
            <div style="margin-bottom: 10px;">
                ...
                <select id="workerRoles" name="workerRoles" style="width: 100%;">
                    ...
                    #if (user.getWorkerRoles()?first!("")) == "RETAIL_CUSTOMER">selected<
                    /#if>>Розничный покупатель</option>
                    <option value="SELLER" <
                    #if (user.getWorkerRoles()?first!("")) == "SELLER">selected<
                    /#if>>Продавец</option>
                    <option value="INSTALLER" <
                    #if (user.getWorkerRoles()?first!("")) == "INSTALLER">selected<
                    /#if>>Монтажник</option>
                    <option value="GRO_SPECIALIST" <
                    #if (user.getWorkerRoles()?first!("")) == "GRO_SPECIALIST">selected<
                    /#if>>Специалист ГРО</option>
                    <option value="ACS_SPECIALIST" <
                    #if (user.getWorkerRoles()?first!("")) == "ACS_SPECIALIST">selected<
